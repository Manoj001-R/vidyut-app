...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1317: s => JSON.stringify(s),
      _1318: s => printToConsole(s),
      _1319: (o, p, r) => o.replaceAll(p, () => r),
      _1321: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1322: s => s.toUpperCase(),
      _1323: s => s.trim(),
      _1324: s => s.trimLeft(),
      _1325: s => s.trimRight(),
      _1326: (string, times) => string.repeat(times),
      _1327: Function.prototype.call.bind(String.prototype.indexOf),
      _1328: (s, p, i) => s.lastIndexOf(p, i),
      _1329: (string, token) => string.split(token),
      _1330: Object.is,
      _1331: (a, i) => a.push(i),
      _1335: a => a.pop(),
      _1336: (a, i) => a.splice(i, 1),
      _1337: (a, s) => a.join(s),
      _1338: (a, s, e) => a.slice(s, e),
      _1340: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1341: a => a.length,
      _1343: (a, i) => a[i],
      _1344: (a, i, v) => a[i] = v,
      _1346: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1347: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1348: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1349: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      ...
      _1352: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1355: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1356: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1357: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1358: (t, s) => t.set(s),
      _1359: l => new DataView(new ArrayBuffer(l)),
      _1360: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1362: o => o.buffer,
      _1363: o => o.byteOffset,
      _1364: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1365: (b, o) => new DataView(b, o),
      _1366: (b, o, l) => new DataView(b, o, l),
      _1367: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1368: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1369: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1370: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1371: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1372: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1373: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1374: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1375: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1376: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1377: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1378: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1381: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1382: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1383: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1384: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1385: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1386: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1409: () => Date.now(),
      _1410: (x0,x1) => new WebSocket(x0,x1),
      _1411: (x0,x1) => x0.send(x1),
      _1412: (x0,x1,x2) => x0.close(x1,x2),
      _1413: (x0,x1) => x0.close(x1),
      _1414: x0 => x0.close(),
      ...
      _1527: () => globalThis.document,
      _1547: x0 => x0.src,
      _1548: (x0,x1) => x0.src = x1,
      _1549: x0 => x0.naturalWidth,
      _1550: x0 => x0.naturalHeight,
      _1566: x0 => x0.status,
      _1567: (x0,x1) => x0.responseType = x1,
      _1569: x0 => x0.response,
      _3406: () => globalThis.window,
      _3449: x0 => x0.location,
      _3468: x0 => x0.navigator,
      _3732: x0 => x0.localStorage,
      _3740: x0 => x0.href,
      _3857: x0 => x0.userAgent,
      _3908: x0 => x0.data,
      _3955: (x0,x1) => x0.onmessage = x1,
      _4062: x0 => x0.length,
      _4279: x0 => x0.readyState,
      _4292: (x0,x1) => x0.binaryType = x1,
      _4295: x0 => x0.code,
      _4296: x0 => x0.reason,
      _6004: x0 => x0.signal,
      _7840: x0 => x0.value,
...
"+91 98765 43210",
"Address",
"Flat 12B, Sunshine Apartments, Andheri West, Mumbai - 400058",
"Member Since",
"January 2023",
"Recent Orders",
"View All",
"Philips LED Smart Bulb 9W x2",
"Delivered • Jan 15, 2024",
"₹598",
"Finolex Copper Wire 90m x1",
"In Transit • Jan 14, 2024",
"₹900",
"Anchor Roma Switch 6A x4",
"Processing • Jan 13, 2024",
"₹180",
"Logout",
"pixel",
"CacheExtentStyle.",
...
"totalAmount",
"products",
"Philips LED Smart Bulb 9W",
"qty",
"price",
"imageUrl",
"https://raw.githubusercontent.com/sowrabb/images/main/images/lights/lights1.jpeg",
"Finolex Copper Wire 90m",
"https://raw.githubusercontent.com/sowrabb/images/main/images/wires and cables/black_wire.jpeg",
"buyer",
"payment",
"UPI",
"tracking",
...
"2024-01-14",
"11:45 AM",
"Anchor Roma Switch 6A",
"https://raw.githubusercontent.com/sowrabb/images/main/images/switches/switches1.jpeg",
"Stanley Screwdriver Set",
"https://raw.githubusercontent.com/sowrabb/images/main/images/tools/tools1.jpeg",
"Havells LED Panel Light",
"https://raw.githubusercontent.com/sowrabb/images/main/images/lights/lights2.jpeg",
"Priya Patel",
"House No. 45, Green Valley Society, Thane West, Mumbai - 400601",
"+91 87654 32109",
"Credit Card",
"IN123456790",
"2024-01-22",
...
"2024-01-13",
"9:15 AM",
"Schneider Circuit Breaker 32A",
"https://raw.githubusercontent.com/sowrabb/images/main/images/circuit breakers/circuit1.jpeg",
"Amit Kumar",
"Shop No. 12, Commercial Complex, Bandra East, Mumbai - 400051",
"+91 76543 21098",
"Net Banking",
"IN123456791",
"2024-01-25",
...
"2024-01-12",
"3:20 PM",
"Duracell AA Battery Pack (4)",
"image",
"assets/battery.jpg",
"Eveready LED Bulb 7W",
"assets/bulb2.jpg",
"Neha Singh",
"A-15, Royal Heights, Vashi, Navi Mumbai - 400703",
"+91 65432 10987",
"IN123456792",
"ORD-2024-005",
"2024-01-11",
"1:10 PM",
"HPL Digital Energy Meter",
"assets/meter.jpg",
"Vikram Mehta",
"Office 302, Business Park, Powai, Mumbai - 400076",
"+91 54321 09876",
"IN123456793",
"2024-01-16",
"Order Management",
...
"description",
"Leading construction and engineering company with expertise in power, infrastructure, and heavy engineering. Major player in electrical equipment procurement for large-scale projects.",
"departments",
"Electrical",
"Civil",
"Mechanical",
...
"27AABCT0001A1Z6",
"+91 22 6665 8282",
"Tata Centre, 43, J.N. Heredia Marg, Ballard Estate, Mumbai - 400001",
"Specialized in urban infrastructure, power transmission, and industrial projects. Regular buyer of electrical equipment and components.",
"Power Transmission",
...
"07AABCG0001A1Z7",
"+91 11 3019 1000",
"GMR House, NH-8, New Delhi - 110037",
"Diversified infrastructure company with focus on airports, power, and urban infrastructure. Significant electrical equipment requirements.",
"Airports",
"Highways",
"₹300-1500 Cr",
"15,000+",
...
"27AABCS0001A1Z8",
"+91 22 6652 5000",
"Shapoorji Mansion, 3rd Floor, 17, Maharshi Karve Road, Mumbai - 400020",
"One of India's largest construction companies with expertise in residential, commercial, and industrial projects.",
"Residential",
"Commercial",
"Infrastructure",
"₹400-1200 Cr",
...
"info@shapoorjipallonji.com",
"Hindustan Construction Co.",
"₹6,800 Cr",
"27AABCH0001A1Z9",
"+91 22 2576 7600",
"Hincon House, 247, Dr. Annie Besant Road, Worli, Mumbai - 400030",
"Leading infrastructure company specializing in transportation, power, and water projects. Regular procurement of electrical systems.",
"Transportation",
"Water",
"₹150-600 Cr",
"8,000+",
...
"27AABCI0001A1Z0",
"+91 22 6121 6000",
"Chandivali Farm Road, Chandivali, Andheri East, Mumbai - 400072",
"Specialized in highway construction and infrastructure development. Requires electrical equipment for toll systems and infrastructure.",
"Toll Systems",
"Maintenance",
"₹100-400 Cr",
"3,500+",
...
"_distance",
"Enterprise Profiles",
"Connect with construction companies and enterprises",
"Filters",
"All Types",
"Construction",
"Real Estate",
...
"3 hours ago",
"List New Product",
"Start selling your electrical products",
"Enter product name",
"Product Name",
"Price (₹)",
...
"Category",
"Lights",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/6.png",
"Wires",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/5.png",
"Tools",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/4.png",
"Switches",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/3.png",
"Battery",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/2.png",
"Meter",
"https://raw.githubusercontent.com/sowrabb/images/main/categories/1.png",
"List Item",
"Dashboard",
"End Users",
"fade",
...
"Schneider",
"Search for bulbs, wires, switches...",
"Recent Searches",
"Clear All",
"Search Results",
" items",
...
"category",
"lights",
"https://raw.githubusercontent.com/sowrabb/images/main/images/lights/lights3.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/lights/lights4.jpeg",
"colors",
"Warm White",
"Cool White",
"sizes",
...
"Smart Compatible",
"Eco-Friendly",
"High-quality LED smart bulb with excellent energy efficiency and long lifespan. Perfect for modern homes with smart lighting requirements.",
"1 Year",
"WireWorld",
"wires and cables",
"https://raw.githubusercontent.com/sowrabb/images/main/images/wires and cables/color_wires.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/wires and cables/premium_copper_wire_product.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/wires and cables/black_wire (1).jpeg",
"Red",
"Blue",
"1.5mm²",
"2.5mm²",
...
"BIS Certified",
"Long Length",
"Premium quality copper wire with excellent conductivity and durability. Ideal for electrical installations and wiring projects.",
"SwitchPro",
"switches",
"https://raw.githubusercontent.com/sowrabb/images/main/images/switches/switches2.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/switches/switches3.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/switches/switches4.jpeg",
"Ivory",
"6A",
"10A",
"16A",
...
"Multiple Colors",
"Wide Application",
"Reliable and durable electrical switch with modern design. Perfect for residential and commercial installations.",
"3 Years",
"CircuitPro",
"circuit breakers",
"https://raw.githubusercontent.com/sowrabb/images/main/images/circuit breakers/circuit2.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/circuit breakers/circuit3.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/circuit breakers/circuit4.jpeg",
"Grey",
"32A",
"40A",
"63A",
...
"Professional grade circuit breaker with high breaking capacity and reliable protection for electrical installations.",
"Stanley Professional Tool Set",
"ToolMart",
"tools",
"https://raw.githubusercontent.com/sowrabb/images/main/images/tools/tools2.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/tools/tools3.jpeg",
"https://raw.githubusercontent.com/sowrabb/images/main/images/tools/tools4.jpeg",
"Professional",
"Heavy Duty",
...
"Portable Case",
"Lifetime Warranty",
"Professional grade tool set with ergonomic design and durable construction. Perfect for electrical work and maintenance.",
"Iw==",
"JA==",
"% OFF",
"by ",
...
"Seller Profile",
"4.5 (1,234 ratings)",
"Trusted Electrical Goods Supplier",
"Business Statistics",
"2,500+",
"Products Sold",
"98%",
...
"Years Experience",
"About ElectricMart",
"We are a leading supplier of electrical goods, serving customers across India since 2010. Our commitment to quality, reliability, and customer satisfaction has made us a trusted name in the electrical industry.",
"• Premium quality electrical products",
"• Fast and reliable delivery",
"• 24/7 customer support",
"• 2-year warranty on all products",
"electricmart@email.com",
"Mon-Sat: 9:00 AM - 8:00 PM",
"Recent Reviews",
"Excellent quality products and fast delivery!",
"Great customer service and reliable products.",
"Amit K.",
"Best electrical supplier I have found.",
"Contact Seller",
"View Store",
"_CardVariant.",
"_pageController",
...
"Bajaj LED Bulb",
"Polycab House Wire",
"Havells LifeLine Wire",
"RR Kabel Wire",
"KEI Home Wire",
"Anchor Advance Wire",
"GM Modular Switch",
"Legrand Myrius Switch",
"Havells Fabio Switch",
"Schneider Opale Switch",
"Goldmedal Curve Switch",
"Batteries",
"Eveready AA Battery (Pack of 4)",
"Duracell AAA Battery (Pack of 2)",
"Panasonic 9V Battery",
"Varta D Size Battery",
"Energizer C Battery",
"Nippo Gold Battery",
"Taparia Pliers",
"Bosch Drill Machine",
...
"L&T kWh Meter",
"Secure Premier Meter",
"Genus Power Meter",
"Elmeasure Digital Meter",
"Product ",
"Tube Lights",
"Panel Lights",
"Chandeliers",
...
"sb-",
"https://kabyeevynjwusvmjtvwi.supabase.co",
"-auth-token",
...
"supabase.supabase",
"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImthYnllZXZ5bmp3dXN2bWp0dndpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU4NzYyMDgsImV4cCI6MjA3MTQ1MjIwOH0.rJ9uIG_0EqLWOm2_lhQ12SiE9RFhhcEMpkFMNpVCqTo",
"https://kabyeevynjwusvmjtvwi.supabase.co/rest/v1",
"https://kabyeevynjwusvmjtvwi.supabase.co/realtime/v1",
"ws",
"https://kabyeevynjwusvmjtvwi.supabase.co/auth/v1",
"https://kabyeevynjwusvmjtvwi.supabase.co/storage/v1",
"https://kabyeevynjwusvmjtvwi.supabase.co/functions/v1",
"public",
